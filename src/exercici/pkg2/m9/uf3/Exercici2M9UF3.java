...
public class Exercici2M9UF3 {
     ...
     * ***************************************************************************************************************************
     */
    public static void comunicacionsURL(URL url) {

        try {
            URLConnection myURLConnection = url.openConnection();
            myURLConnection.connect();
        } catch (IOException ex) {
            Logger.getLogger(Exercici2M9UF3.class.getName()).log(Level.SEVERE, null, ex);
        }

    }

    public static void imprimirPartesDeWeb(URL url, String etiqueta) {
